  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        {/* Claude */}
        <Card className={claude?.status === 'active' ? 'border-success/50' : ''}>
          ...
          <CardContent>
            <div className="text-xs text-muted-foreground mb-2">Primary agent — architecture, releases</div>
            {claude?.status === 'active' && claude?.task && (
              <div className="p-2 rounded bg-primary/10 border-l-2 border-primary text-sm mt-2">
                <div className="font-medium">{claude.task}</div>
                {claude.phase && <div className="text-xs text-muted-foreground mt-1">Phase: {claude.phase}</div>}
              </div>
            )}
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xs text-muted-foreground mb-2">Backup + dispatch + coordination</div>
